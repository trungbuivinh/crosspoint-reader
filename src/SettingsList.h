...
inline const std::vector<SettingInfo>& getBaseSettingsList() {
  static const std::vector<SettingInfo> baseList = [] {
    ...
    // Add one entry at a time. A single braced initializer materializes every
    // SettingInfo temporary together and costs almost 10 KB of task stack.
    std::vector<SettingInfo> v;
    v.reserve(56);
    auto add = [&v](SettingInfo setting) { v.push_back(std::move(setting)); };

    // --- Display ---
    add(SettingInfo::Enum(StrId::STR_SLEEP_SCREEN, &CrossPointSettings::sleepScreen, std::move(sleepScreenValues),
    ...
    add(SettingInfo::Enum(StrId::STR_FONT_SIZE, nullptr, {}, "fontSize", StrId::STR_CAT_READER).withTextSettings());
    ...
    add(SettingInfo::Enum(StrId::STR_TOUCH_READER_CONTROLS, &CrossPointSettings::touchReaderControls,
                          {StrId::STR_STATE_OFF, StrId::STR_STATE_ON}, "touchReaderControls", StrId::STR_CAT_CONTROLS));
    add(SettingInfo::Toggle(StrId::STR_FRONT_BTN_FOLLOW_ORIENTATION, &CrossPointSettings::frontButtonFollowOrientation,
    ...
    add(SettingInfo::Enum(StrId::STR_LONG_PRESS_MENU, &CrossPointSettings::longPressMenuFunction,
    ...
    add(SettingInfo::Toggle(StrId::STR_BACK_SHORT_TO_FILE_BROWSER, &CrossPointSettings::backShortToFileBrowser,
    ...
    add(SettingInfo::String(StrId::STR_OPDS_DOWNLOAD_FOLDER, &SETTINGS.opdsDownloadFolder[0],
    ...
    add(SettingInfo::Enum(StrId::STR_OPDS_FILENAME_FORMAT, &CrossPointSettings::opdsFilenameFormat,
    ...
    add(SettingInfo::DynamicString(StrId::STR_GDRIVE_FOLDER_ID, &gdriveGetFolderId, &gdriveSetFolderId,
                                   "gdriveFolderId", StrId::STR_GDRIVE_SYNC));
    add(SettingInfo::DynamicString(StrId::STR_GDRIVE_API_KEY, &gdriveGetApiKey, &gdriveSetApiKey, "gdriveApiKey",
                                   StrId::STR_GDRIVE_SYNC));
    add(SettingInfo::DynamicDirectory(StrId::STR_GDRIVE_LOCAL_FOLDER, &gdriveGetLocalFolder, &gdriveSetLocalFolder,
    ...
    add(SettingInfo::Enum(StrId::STR_CLOCK, &CrossPointSettings::statusBarClock, std::move(statusBarClockValues),
